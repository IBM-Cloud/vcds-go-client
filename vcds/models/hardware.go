...
// Hardware Hardware configuration of the vSphere servers.
...
func (m *Hardware) validateCustomizedHardware(formats strfmt.Registry) error {
...
func (m *Hardware) validateQuantity(formats strfmt.Registry) error {
