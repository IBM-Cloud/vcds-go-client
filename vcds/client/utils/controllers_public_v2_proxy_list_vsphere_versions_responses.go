...
func (o *ControllersPublicV2ProxyListVsphereVersionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewControllersPublicV2ProxyListVsphereVersionsOK()
...
func NewControllersPublicV2ProxyListVsphereVersionsOK() *ControllersPublicV2ProxyListVsphereVersionsOK {
	return &ControllersPublicV2ProxyListVsphereVersionsOK{}
}
...
func (o *ControllersPublicV2ProxyListVsphereVersionsOK) Error() string {
	return fmt.Sprintf("[GET /v2/vsphere_versions][%d] controllersPublicV2ProxyListVsphereVersionsOK  %+v", 200, o.Payload)
}

func (o *ControllersPublicV2ProxyListVsphereVersionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	// response header x-global-transaction-id
	o.XGlobalTransactionID = response.GetHeader("x-global-transaction-id")

	o.Payload = new(models.DefVsphereVersions)
