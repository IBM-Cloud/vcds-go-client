...
// NewControllersPublicV2ProxyListLocationsParams creates a new ControllersPublicV2ProxyListLocationsParams object
// with the default values initialized.
func NewControllersPublicV2ProxyListLocationsParams() *ControllersPublicV2ProxyListLocationsParams {
	var ()
	return &ControllersPublicV2ProxyListLocationsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewControllersPublicV2ProxyListLocationsParamsWithTimeout creates a new ControllersPublicV2ProxyListLocationsParams object
...
// NewControllersPublicV2ProxyListLocationsParamsWithContext creates a new ControllersPublicV2ProxyListLocationsParams object
...
// NewControllersPublicV2ProxyListLocationsParamsWithHTTPClient creates a new ControllersPublicV2ProxyListLocationsParams object
...
/*ControllersPublicV2ProxyListLocationsParams contains all the parameters to send to the API endpoint
for the controllers public v2 proxy list locations operation typically these are written to a http.Request
*/
