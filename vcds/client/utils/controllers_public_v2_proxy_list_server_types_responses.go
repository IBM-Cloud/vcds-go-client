...
func (o *ControllersPublicV2ProxyListServerTypesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewControllersPublicV2ProxyListServerTypesOK()
...
func NewControllersPublicV2ProxyListServerTypesOK() *ControllersPublicV2ProxyListServerTypesOK {
	return &ControllersPublicV2ProxyListServerTypesOK{}
}
...
func (o *ControllersPublicV2ProxyListServerTypesOK) Error() string {
	return fmt.Sprintf("[GET /v2/server_types][%d] controllersPublicV2ProxyListServerTypesOK  %+v", 200, o.Payload)
}

func (o *ControllersPublicV2ProxyListServerTypesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	// response header x-global-transaction-id
	o.XGlobalTransactionID = response.GetHeader("x-global-transaction-id")

	o.Payload = new(models.DefServerTypes)
