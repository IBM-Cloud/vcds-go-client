...
// NewControllersPublicV1ProxyDeleteVcenterParams creates a new ControllersPublicV1ProxyDeleteVcenterParams object
// with the default values initialized.
func NewControllersPublicV1ProxyDeleteVcenterParams() *ControllersPublicV1ProxyDeleteVcenterParams {
	var ()
	return &ControllersPublicV1ProxyDeleteVcenterParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewControllersPublicV1ProxyDeleteVcenterParamsWithTimeout creates a new ControllersPublicV1ProxyDeleteVcenterParams object
...
// NewControllersPublicV1ProxyDeleteVcenterParamsWithContext creates a new ControllersPublicV1ProxyDeleteVcenterParams object
...
// NewControllersPublicV1ProxyDeleteVcenterParamsWithHTTPClient creates a new ControllersPublicV1ProxyDeleteVcenterParams object
...
/*ControllersPublicV1ProxyDeleteVcenterParams contains all the parameters to send to the API endpoint
for the controllers public v1 proxy delete vcenter operation typically these are written to a http.Request
*/
...
func (o *ControllersPublicV1ProxyDeleteVcenterParams) WithTimeout(timeout time.Duration) *ControllersPublicV1ProxyDeleteVcenterParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the controllers public v1 proxy delete vcenter params
func (o *ControllersPublicV1ProxyDeleteVcenterParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the controllers public v1 proxy delete vcenter params
func (o *ControllersPublicV1ProxyDeleteVcenterParams) WithContext(ctx context.Context) *ControllersPublicV1ProxyDeleteVcenterParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the controllers public v1 proxy delete vcenter params
func (o *ControllersPublicV1ProxyDeleteVcenterParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the controllers public v1 proxy delete vcenter params
func (o *ControllersPublicV1ProxyDeleteVcenterParams) WithHTTPClient(client *http.Client) *ControllersPublicV1ProxyDeleteVcenterParams {
...
func (o *ControllersPublicV1ProxyDeleteVcenterParams) WithAuthorization(authorization string) *ControllersPublicV1ProxyDeleteVcenterParams {
...
func (o *ControllersPublicV1ProxyDeleteVcenterParams) WithInstanceID(instanceID string) *ControllersPublicV1ProxyDeleteVcenterParams {
...
func (o *ControllersPublicV1ProxyDeleteVcenterParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
